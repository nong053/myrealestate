...
if ($user) {
	...
	if($_GET["code"] != "")
	{
		...
		echo $_SESSION['ses_cus_id'];
				...
				$objConnect = mysql_connect("localhost","adsthaidd","010535546") or die(mysql_error());
				$objDB = mysql_select_db("adsthaid_db");
            ...
            <div class="container">
                <div class="row rowFooter">
                    ...
                    <div class="col-xs-4 map-img xs-margin-bottom-40">
                        ...
                        Email2: <a href="mailto:sale@adsthaidd.com" class="">sale@adsthaidd.com</a>
